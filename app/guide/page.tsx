...
export default async function Guide() {
  ...
  return <main>
    <header className="top"><div><div className="brand">MOM<span>SAT</span></div><div className="muted">Live Program Guide</div></div><nav><Link href="/browse">شبکه‌ها</Link><Link href="/settings">تنظیمات</Link><Link href="/admin">مدیریت</Link></nav></header>
